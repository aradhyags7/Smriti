...
import 'package:smriti_app/screens/end_screen.dart';
import 'package:smriti_app/screens/pulse_trainer_screen.dart';
import 'package:smriti_app/features/cognitive/spatial_memory/screens/wayfinder_home_screen.dart';
import 'package:smriti_app/features/cognitive/working_memory/screens/sequence_home_screen.dart';
...
void main() {
  ...
  testWidgets('EndScreen renders title, score, and buttons',
    ...
    expect(find.text('Test Game - Game Over'), findsWidgets);
